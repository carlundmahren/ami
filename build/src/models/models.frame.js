 ...
 * @module models/frame
 */
class ModelsFrame extends models_base_1.default {
    /**
     * Constructor
     */
    constructor() {
     ...
     */
    cosines() {
        let cosines = [new Vector3_1.Vector3(1, 0, 0), new Vector3_1.Vector3(0, 1, 0), new Vector3_1.Vector3(0, 0, 1)];
        if (this._imageOrientation && this._imageOrientation.length === 6) {
            let xCos = new Vector3_1.Vector3(this._imageOrientation[0], this._imageOrientation[1], this._imageOrientation[2]);
            let yCos = new Vector3_1.Vector3(this._imageOrientation[3], this._imageOrientation[4], this._imageOrientation[5]);
            if (xCos.length() > 0 && yCos.length() > 0) {
                cosines[0] = xCos;
                cosines[1] = yCos;
                cosines[2] = new Vector3_1.Vector3(0, 0, 0).crossVectors(cosines[0], cosines[1]).normalize();
            }
        }
        else {
...
//# sourceMappingURL=models.frame.js.map