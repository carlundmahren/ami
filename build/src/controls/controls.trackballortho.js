...
const trackballOrtho = (three = window.THREE) => {
    ...
    return class extends Constructor {
        constructor(object, domElement, state = {
            ...
            let EPS = 0.000001;
            let _changed = true;
            let _state = STATE.NONE, _prevState = STATE.NONE, _eye = new three.Vector3(), _zoomStart = new three.Vector2(), _zoomEnd = new three.Vector2(), _touchZoomDistanceStart = 0, _touchZoomDistanceEnd = 0, _panStart = new three.Vector2(), _panEnd = new three.Vector2();
...
exports.trackballOrtho = trackballOrtho;
// default export to
exports.default = trackballOrtho();
//# sourceMappingURL=controls.trackballortho.js.map