...
void main(void) {
  ...
  if (steps > 1.) {
    ...
    for (float step = 0.; step < 128.; step++) {
      ...
      ${(0, shaders_interpolation_1.default)(this, 'currentVoxel', 'dataValueAcc', 'gradient')};
    ...
    vec3 currentVoxel = dataCoordinates.xyz;
    ${(0, shaders_interpolation_1.default)(this, 'currentVoxel', 'dataValue', 'gradient')}
  }
...
//# sourceMappingURL=shaders.data.fragment.js.map