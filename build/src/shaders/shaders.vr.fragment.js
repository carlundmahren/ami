...
const shaders_interpolation_1 = __importDefault(require("./interpolation/shaders.interpolation"));
const shaders_helpers_intersectBox_1 = __importDefault(require("./helpers/shaders.helpers.intersectBox"));
...
void getIntensity(in vec3 dataCoordinates, out float intensity, out vec3 gradient){
  ...
  ${(0, shaders_interpolation_1.default)(this, 'dataCoordinates', 'dataValue', 'gradient')}
...
void main(void) {
  ...
  ${shaders_helpers_intersectBox_1.default.api(this, 'rayOrigin', 'rayDirection', 'AABBMin', 'AABBMax', 'tNear', 'tFar', 'intersect')}
...
//# sourceMappingURL=shaders.vr.fragment.js.map