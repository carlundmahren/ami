...
/** Imports **/
const helpers_progressbar_1 = __importDefault(require("../helpers/helpers.progressbar"));
 ...
 * );
 */
class LoadersBase extends events_1.default {
    /**
     * Create a Loader.
     * @param {dom} container - The dom container of loader.
     * @param {object} ProgressBar - The progressbar of loader.
     */
    constructor(container = null, ProgressBar = helpers_progressbar_1.default) {
        super();
        this._loaded = -1;
        this._totalLoaded = -1;
        this._parsed = -1;
...
//# sourceMappingURL=loaders.base.js.map