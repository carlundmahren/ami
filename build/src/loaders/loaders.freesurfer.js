        ...
        switch (surfType) {
            case THREE.FreeSurferLoader.QUAD_FILE_MAGIC_NUMBER: {
                ...
                for (let v = 0; v < vertCount; v++) {
                    geometry.vertices.push(new THREE.Vector3(reader.getInt16(offset + 0, littleEndian) / 100, reader.getInt16(offset + 2, littleEndian) / 100, reader.getInt16(offset + 4, littleEndian) / 100));
                    offset += 6;
                }
            ...
            case THREE.FreeSurferLoader.TRIANGLE_FILE_MAGIC_NUMBER: {
                ...
                geometry = new THREE.Geometry();
                for (let v = 0; v < vertCount; v++) {
                    geometry.vertices.push(new THREE.Vector3(reader.getFloat32(offset + 0, littleEndian), reader.getFloat32(offset + 4, littleEndian), reader.getFloat32(offset + 8, littleEndian)));
                    offset += 12;
                }
                for (let f = 0; f < faceCount; f++) {
...
//# sourceMappingURL=loaders.freesurfer.js.map