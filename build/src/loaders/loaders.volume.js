...
const loaders_base_1 = __importDefault(require("./loaders.base"));
const core_utils_1 = __importDefault(require("../core/core.utils"));
const models_series_1 = __importDefault(require("../models/models.series"));
const models_stack_1 = __importDefault(require("../models/models.stack"));
const models_frame_1 = __importDefault(require("../models/models.frame"));
const parsers_dicom_1 = __importDefault(require("../parsers/parsers.dicom"));
const parsers_mhd_1 = __importDefault(require("../parsers/parsers.mhd"));
const parsers_nifti_1 = __importDefault(require("../parsers/parsers.nifti"));
const parsers_nrrd_1 = __importDefault(require("../parsers/parsers.nrrd"));
const parsers_mgh_1 = __importDefault(require("../parsers/parsers.mgh"));
/**
 *
 ...
 * );
 */
class LoadersVolumes extends loaders_base_1.default {
    /**
     * Parse response.
        ...
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                resolve(new Promise((resolve, reject) => {
                    ...
                    // create a series
                    let series = new models_series_1.default();
                    ...
                    let stack = new models_stack_1.default();
    ...
    parseFrame(series, stack, url, i, dataParser, resolve, reject) {
        let frame = new models_frame_1.default();
    ...
    _parser(extension) {
        ...
        switch (extension.toUpperCase()) {
            case 'NII':
            case 'NII_':
                Parser = parsers_nifti_1.default;
                break;
            case 'DCM':
            case 'DIC':
            case 'DICOM':
            case 'IMA':
            case '':
                Parser = parsers_dicom_1.default;
                break;
            case 'MHD':
                Parser = parsers_mhd_1.default;
                break;
            case 'NRRD':
                Parser = parsers_nrrd_1.default;
                break;
            case 'MGH':
            case 'MGZ':
                Parser = parsers_mgh_1.default;
                break;
            default:
     ...
     */
    _preprocess(data) {
        const parsedUrl = core_utils_1.default.parseUrl(data.url);
        // update data
