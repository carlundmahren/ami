...
exports.helpersStack = void 0;
/** * Imports ***/
const helpers_border_1 = require("../helpers/helpers.border");
const helpers_boundingbox_1 = require("../helpers/helpers.boundingbox");
const helpers_slice_1 = require("../helpers/helpers.slice");
/**
...
const helpersStack = (three = window.THREE) => {
    ...
    return class extends Constructor {
         ...
         */
        _prepareBBox() {
            const HelpersBoundingBoxConstructor = (0, helpers_boundingbox_1.helpersBoundingBox)(three);
         ...
         */
        _prepareBorder() {
            const HelpersBorderContructor = (0, helpers_border_1.helpersBorder)(three);
        ...
        _prepareSlice() {
            ...
            const SliceHelperConstructor = (0, helpers_slice_1.helpersSlice)(three);
...
exports.helpersStack = helpersStack;
// default export to
exports.default = helpersStack();
//# sourceMappingURL=helpers.stack.js.map