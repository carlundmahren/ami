...
exports.helpersSlice = void 0;
/** * Imports ***/
const geometries_slice_1 = require("../geometries/geometries.slice");
const shaders_data_uniform_1 = __importDefault(require("../shaders/shaders.data.uniform"));
const shaders_data_vertex_1 = __importDefault(require("../shaders/shaders.data.vertex"));
const shaders_data_fragment_1 = __importDefault(require("../shaders/shaders.data.fragment"));
const helpers_material_mixin_1 = require("../helpers/helpers.material.mixin");
/**
...
const helpersSlice = (three = window.THREE) => {
    ...
    const Constructor = (0, helpers_material_mixin_1.helpersMaterialMixin)(three);
    return class extends Constructor {
        constructor(stack, index = 0, position = new three.Vector3(0, 0, 0), direction = new three.Vector3(0, 0, 1), aabbSpace = 'IJK') {
            ...
            this._material = null;
            this._textures = [];
            this._shadersFragment = shaders_data_fragment_1.default;
            this._shadersVertex = shaders_data_vertex_1.default;
            this._uniforms = shaders_data_uniform_1.default.uniforms();
            this._geometry = null;
            this._mesh = null;
            this._visible = true;
        ...
        _create() {
            ...
            // Convenience vars
            try {
                const SliceGeometryContructor = (0, geometries_slice_1.geometriesSlice)(three);
...
exports.helpersSlice = helpersSlice;
exports.default = helpersSlice();
//# sourceMappingURL=helpers.slice.js.map