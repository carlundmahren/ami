 ...
 */
const controls_trackball_1 = __importDefault(require("../../controls/controls.trackball"));
class default_1 {
    ...
    _initControls() {
        // controls
        this._controls = new controls_trackball_1.default(this._camera, this._container);
...
//# sourceMappingURL=helpers.x.renderer3d.js.map