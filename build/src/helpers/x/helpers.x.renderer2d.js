 ...
 */
const cameras_orthographic_1 = __importDefault(require("../../cameras/cameras.orthographic"));
const controls_trackballortho_1 = __importDefault(require("../../controls/controls.trackballortho"));
...
class default_1 {
    ...
    _initCamera() {
        this._camera = new cameras_orthographic_1.default(this._container.clientWidth / -2, this._container.clientWidth / 2, this._container.clientHeight / 2, this._container.clientHeight / -2, 1, 1000);
    }
    _initScene() {
    ...
    _initControls() {
        // controls
        this._controls = new controls_trackballortho_1.default(this._camera, this._container);
    ...
    _setupCamera(stack) {
        ...
        let lpsDims = new Vector3_1.Vector3(worldbb[1] - worldbb[0], worldbb[3] - worldbb[2], worldbb[5] - worldbb[4]);
        // box: {halfDimensions, center}
        let box = {
            center: stack.worldCenter().clone(),
            halfDimensions: new Vector3_1.Vector3(lpsDims.x + 10, lpsDims.y + 10, lpsDims.z + 10),
        };
        // init and zoom
        let canvas = {
...
//# sourceMappingURL=helpers.x.renderer2d.js.map