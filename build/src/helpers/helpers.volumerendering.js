...
exports.helpersVolumeRendering = void 0;
/** * Imports ***/
const shaders_vr_uniform_1 = __importDefault(require("../shaders/shaders.vr.uniform"));
const shaders_vr_vertex_1 = __importDefault(require("../shaders/shaders.vr.vertex"));
const shaders_vr_fragment_1 = __importDefault(require("../shaders/shaders.vr.fragment"));
...
const helpersVolumeRendering = (three = window.THREE) => {
    ...
    return class extends Constructor {
        constructor(stack) {
            ...
            this._stack = stack;
            this._textures = [];
            this._shadersFragment = shaders_vr_fragment_1.default;
            this._shadersVertex = shaders_vr_vertex_1.default;
            this._uniforms = shaders_vr_uniform_1.default.uniforms();
            this._material = null;
            this._geometry = null;
            this._mesh = null;
...
exports.helpersVolumeRendering = helpersVolumeRendering;
exports.default = helpersVolumeRendering();
//# sourceMappingURL=helpers.volumerendering.js.map