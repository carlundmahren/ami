...
exports.helpersLocalizer = void 0;
/** * Imports ***/
const shaders_localizer_uniform_1 = __importDefault(require("../shaders/shaders.localizer.uniform"));
const shaders_localizer_vertex_1 = __importDefault(require("../shaders/shaders.localizer.vertex"));
const shaders_localizer_fragment_1 = __importDefault(require("../shaders/shaders.localizer.fragment"));
/**
...
const helpersLocalizer = (three = window.THREE) => {
    ...
    return class extends Constructor {
        constructor(stack, geometry, referencePlane) {
            ...
            this._shadersFragment = shaders_localizer_fragment_1.default;
            this._shadersVertex = shaders_localizer_vertex_1.default;
            this._uniforms = shaders_localizer_uniform_1.default.uniforms();
            this._material = null;
        ...
        _prepareMaterial() {
            if (!this._material) {
                ...
                // generate material
                let fs = new shaders_localizer_fragment_1.default(this._uniforms);
                let vs = new shaders_localizer_vertex_1.default();
...
exports.helpersLocalizer = helpersLocalizer;
exports.default = helpersLocalizer();
//# sourceMappingURL=helpers.localizer.js.map