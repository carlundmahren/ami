...
exports.widgetsVelocityTimeIntegral = void 0;
...
const widgetsVelocityTimeIntegral = (three = window.THREE) => {
    ...
    return class extends Constructor {
        constructor(targetMesh, controls, params = {}) {
            ...
            this._initialRegion = this.getRegionByXY(this._regions, core_utils_1.default.worldToData(params.lps2IJK, params.worldPosition));
        ...
        checkHandle(index, shift) {
            const region = this.getRegionByXY(this._regions, core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[index].worldPosition.clone().add(shift)));
            return (region !== null &&
        ...
        finalize() {
            ...
            const pointF = core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[0]._worldPosition);
            const pointL = core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[this._handles.length - 1]._worldPosition);
        ...
        updateValues() {
            const region = this._regions[this.getRegionByXY(this._regions, core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[0]._worldPosition))];
            const boundaries = {
            ...
            this._handles.slice(0, -2).forEach(elem => {
                const usPosition = this.getPointInRegion(region, core_utils_1.default.worldToData(this._params.lps2IJK, elem._worldPosition));
...
exports.widgetsVelocityTimeIntegral = widgetsVelocityTimeIntegral;
exports.default = widgetsVelocityTimeIntegral();
//# sourceMappingURL=widgets.velocityTimeIntegral.js.map