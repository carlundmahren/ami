...
exports.widgetsCrossRuler = void 0;
    ...
    return class extends Constructor {
        ...
        updateDOM() {
            ...
            const labelPadding = Math.tan(angle) < this._label.offsetHeight / this._label.offsetWidth
                ...
                : this._label.offsetHeight / 2 / Math.cos(Math.PI / 2 - angle) + 15, paddingVector = lineData.line.normalize().multiplyScalar(labelPadding), paddingPoint = lineData.length > labelPadding * 4
                ? this._handles[1].screenPosition.clone().sub(paddingVector)
                : this._handles[1].screenPosition.clone().add(paddingVector), transform = this.adjustLabelTransform(this._label, paddingPoint);
            ...
            const label2Padding = Math.tan(angle2) < this._label2.offsetHeight / this._label2.offsetWidth
                ...
                : this._label2.offsetHeight / 2 / Math.cos(Math.PI / 2 - angle2) + 15, paddingVector2 = line2Data.line.normalize().multiplyScalar(label2Padding), paddingPoint2 = line2Data.length > label2Padding * 4
                ? this._handles[3].screenPosition.clone().sub(paddingVector2)
                : this._handles[3].screenPosition.clone().add(paddingVector2), transform2 = this.adjustLabelTransform(this._label2, paddingPoint2);
        ...
        repositionOrtho() {
            ...
            const intersect = this._handles[0].worldPosition.clone().add(this._line01
                .clone()
                .normalize()
...
exports.widgetsCrossRuler = widgetsCrossRuler;
exports.default = widgetsCrossRuler();
//# sourceMappingURL=widgets.crossRuler.js.map