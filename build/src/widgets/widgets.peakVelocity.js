...
exports.widgetsPeakVelocity = void 0;
...
const widgetsPeakVelocity = (three = window.THREE) => {
    ...
    return class extends Constructor {
        ...
        isCorrectRegion(shift) {
            const region = this.getRegionByXY(this._regions, core_utils_1.default.worldToData(this._params.lps2IJK, this._handle.worldPosition.clone().add(shift)));
            return (region !== null &&
        ...
        updateDOM() {
            this.updateDOMColor();
            const point = core_utils_1.default.worldToData(this._params.lps2IJK, this._worldPosition);
...
exports.widgetsPeakVelocity = widgetsPeakVelocity;
exports.default = widgetsPeakVelocity();
//# sourceMappingURL=widgets.peakVelocity.js.map