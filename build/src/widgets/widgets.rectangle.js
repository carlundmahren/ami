...
exports.widgetsRectangle = void 0;
...
const widgetsRectangle = (three = window.THREE) => {
    ...
    return class extends Constructor {
        ...
        updateDOM() {
            ...
            this._area = core_utils_1.default.getGeometryArea(this._geometry);
            if (this._calibrationFactor) {
                ...
                const region0 = this.getRegionByXY(regions, core_utils_1.default.worldToData(this._stack.lps2IJK, this._handles[0].worldPosition));
                const region1 = this.getRegionByXY(regions, core_utils_1.default.worldToData(this._stack.lps2IJK, this._handles[1].worldPosition));
                if (region0 !== null &&
                    region1 !== null &&
                    region0 === region1 &&
            ...
            const labelTransform = this.adjustLabelTransform(this._label, this._handles[1].screenPosition
                .clone()
...
exports.widgetsRectangle = widgetsRectangle;
exports.default = widgetsRectangle();
//# sourceMappingURL=widgets.rectangle.js.map