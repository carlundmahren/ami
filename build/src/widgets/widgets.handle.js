        ...
        onStart(evt) {
            ...
            if (this._hovered) {
                ...
                if (this._targetMesh) {
                    ...
                    let intersection = core_intersections_1.default.rayPlane(this._raycaster.ray, this._plane);
...
exports.widgetsHandle = widgetsHandle;
exports.default = widgetsHandle();
//# sourceMappingURL=widgets.handle.js.map