...
exports.widgetsPressureHalfTime = void 0;
...
const widgetsPressureHalfTime = (three = window.THREE) => {
    ...
    return class extends Constructor {
        ...
        updateValues() {
            const usPosition0 = this.getUsPoint(this._regions, core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[0].worldPosition));
            const usPosition1 = this.getUsPoint(this._regions, core_utils_1.default.worldToData(this._params.lps2IJK, this._handles[1].worldPosition));
...
exports.widgetsPressureHalfTime = widgetsPressureHalfTime;
exports.default = widgetsPressureHalfTime();
//# sourceMappingURL=widgets.pressureHalfTime.js.map