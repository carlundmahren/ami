...
const nifti_1 = __importDefault(require("nifti-reader-js/src/nifti"));
/**
...
class ParsersNifti extends parsers_volume_1.default {
    constructor(data, id) {
        ...
        //
        this._qfac = 1.0;
        if (nifti_1.default.isNIFTI(this._arrayBuffer)) {
            this._dataSet = nifti_1.default.readHeader(this._arrayBuffer);
            this._niftiImage = nifti_1.default.readImage(this._dataSet, this._arrayBuffer);
        }
        else {
...
//# sourceMappingURL=parsers.nifti.js.map