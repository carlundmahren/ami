 ...
 */
class ParsersNifti extends parsers_volume_1.default {
    /**
     * Constructor
     *
     * @param {*} data
    ...
    pixelSpacing(frameIndex = 0) {
        const x = new Vector3_1.Vector3(this._dataSet.spaceDirections[0][0], this._dataSet.spaceDirections[0][1], this._dataSet.spaceDirections[0][2]);
        const y = new Vector3_1.Vector3(this._dataSet.spaceDirections[1][0], this._dataSet.spaceDirections[1][1], this._dataSet.spaceDirections[1][2]);
        const z = new Vector3_1.Vector3(this._dataSet.spaceDirections[2][0], this._dataSet.spaceDirections[2][1], this._dataSet.spaceDirections[2][2]);
    ...
    imageOrientation(frameIndex = 0) {
        ...
        let x = new Vector3_1.Vector3(this._dataSet.spaceDirections[0][0] * invertX, this._dataSet.spaceDirections[0][1] * invertY, this._dataSet.spaceDirections[0][2]);
        x.normalize();
        let y = new Vector3_1.Vector3(this._dataSet.spaceDirections[1][0] * invertX, this._dataSet.spaceDirections[1][1] * invertY, this._dataSet.spaceDirections[1][2]);
        y.normalize();
...
//# sourceMappingURL=parsers.nrrd.js.map