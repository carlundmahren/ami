 ...
 * @module parsers/mhd
 */
class ParsersMHD extends parsers_volume_1.default {
    constructor(data, id) {
        super();
        /**
         * @member
    ...
    imageOrientation(frameIndex = 0) {
        ...
        let x = new Vector3_1.Vector3(parseFloat(this._header.TransformMatrix[0]) * invertX, parseFloat(this._header.TransformMatrix[1]) * invertY, parseFloat(this._header.TransformMatrix[2]));
        x.normalize();
        let y = new Vector3_1.Vector3(parseFloat(this._header.TransformMatrix[3]) * invertX, parseFloat(this._header.TransformMatrix[4]) * invertY, parseFloat(this._header.TransformMatrix[5]));
        y.normalize();
...
//# sourceMappingURL=parsers.mhd.js.map