 ...
 * @module parsers/mgh
 */
class ParsersMgh extends parsers_volume_1.default {
    constructor(data, id) {
        super();
        /**
         * @member
        ...
        const first = new Vector3_1.Vector3().fromArray(this._Xras);
        const second = new Vector3_1.Vector3().fromArray(this._Yras);
        const crossFirstSecond = new Vector3_1.Vector3().crossVectors(first, second);
        const third = new Vector3_1.Vector3().fromArray(this._Zras);
...
//# sourceMappingURL=parsers.mgh.js.map