...
exports.geometriesSlice = void 0;
/** * Imports ***/
...
const geometriesSlice = (three = window.THREE) => {
    ...
    return class extends Constructor {
        constructor(halfDimensions, center, position, direction, toAABB = new three.Matrix4()) {
            ...
            // BOOM!
            let intersections = core_intersections_1.default.aabbPlane(aabb, plane);
            ...
            let points = core_utils_1.default.orderIntersections(intersections, direction);
            // create the shape
...
exports.geometriesSlice = geometriesSlice;
// default export to
exports.default = geometriesSlice();
//# sourceMappingURL=geometries.slice.js.map