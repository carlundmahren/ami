...
exports.camerasOrthographic = void 0;
const core_intersections_1 = __importDefault(require("../core/core.intersections"));
const core_validators_1 = __importDefault(require("../core/core.validators"));
/**
...
const camerasOrthographic = (three = window.THREE) => {
    ...
    return class extends Constructor {
        ...
        Use .cosines, .controls, .box and .canvas instead.`);
            //
            if (!(core_validators_1.default.vector3(xCosine) &&
                core_validators_1.default.vector3(yCosine) &&
                core_validators_1.default.vector3(zCosine) &&
                core_validators_1.default.box(box) &&
                controls)) {
            ...
            let intersections = this._orderIntersections(core_intersections_1.default.rayBox(ray, this._box), this._direction);
        ...
        fitBox(direction = 0, factor = 1.5) {
            ...
            switch (direction) {
                ...
                case 2:
                    zoom =
                        factor *
                            Math.min(this._computeZoom(this._canvas.width, this._right), this._computeZoom(this._canvas.height, this._up));
                    break;
                default:
                    break;
            }
        ...
        _computeZoom(dimension, direction) {
            ...
            let intersections = core_intersections_1.default.rayBox(ray, this._box);
...
exports.camerasOrthographic = camerasOrthographic;
// default export to
exports.default = camerasOrthographic();
//# sourceMappingURL=cameras.orthographic.js.map